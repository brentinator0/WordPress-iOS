...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "WordPressCom-Stats-iOS/WordPressCom-Stats-iOS/SiteStats.storyboard"
  install_resource "WordPressCom-Stats-iOS/WordPressCom-Stats-iOS/Noticons-Regular.otf"
